...
| Primary focus | file references, storage state, asset metadata |
...
| Field | Value |
| --- | --- |
| Package | `@plugins/files-core` |
| Manifest ID | `files-core` |
| Repo | [gutu-plugin-files-core](https://github.com/gutula/gutu-plugin-files-core) |
...
| Provided Capabilities | `files.assets` |
| Runtime | bun>=1.3.12 |
...
| --- | --- | --- |
| Actions | 1 | `files.assets.register` |
| Resources | 1 | `files.assets` |
...
console.log(registerFileAssetAction.id);
console.log(FileAssetResource.id);
```

Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/files-core` if you need lower-level control.
...
- `plugins/gutu-plugin-files-core/framework/builtin-plugins/files-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-files-core/framework/builtin-plugins/files-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-files-core/framework/builtin-plugins/files-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-files-core/framework/builtin-plugins/files-core/docs/FLOWS.md`
- `plugins/gutu-plugin-files-core/framework/builtin-plugins/files-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-files-core/framework/builtin-plugins/files-core/docs/MANDATORY_STEPS.md`
