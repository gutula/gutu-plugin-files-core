...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/files-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-files-core:");
...
console.log("Documentation check passed for gutu-plugin-files-core.");
